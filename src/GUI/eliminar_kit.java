...
public class eliminar_kit extends javax.swing.JDialog implements KeyListener {
   Kitproductos mainProduct=new Kitproductos(0,null,0,0,null);
...
private JComboBox combo1;
    ...
    public eliminar_kit(Kitproductos kitproductos) throws SQLException {
        initComponents();
        iniciar(kitproductos);
    }


    public void iniciar(Kitproductos kitproducto) throws SQLException {
...
String t[] = {"ID", "NOMBRE", "TALLA", "MARCA", "CANTIDAD ACTUAL", "TIPO", "PROVEEDOR","PRECIO COMPRA", "PRECIO VENTA","CODIGO"};
  ...
  ArrayList<Productos> aux2 = new ArrayList<Productos>();
        ...
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
		         ...
		         aux2 = f.getrelacionKitproductos(this.mainProduct.getIdKitProductos());//Cargar resultados , debe ser por nombres
...
if (JOptionPane.OK_CANCEL_OPTION == confirmado){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Logger.getLogger(eliminar_kit.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
